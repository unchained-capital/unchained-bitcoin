...
describe("transactions", () => {
  ...
  describe("unsignedMultisigTransaction", () => {
    ...
    TEST_FIXTURES.transactions.forEach((fixture) => {
      it(`can construct an unsigned multisig transaction which ${fixture.description}`, () => {
        ...
        if (fixture.psbt) {
          const transactionFromPSBT = unsignedTransactionObjectFromPSBT(unsignedMultisigPSBT(fixture.network, fixture.inputs, fixture.outputs));
  ...
  describe("signedMultisigTransaction", () => {
    ...
    it("can construct a valid signed P2SH_P2WSH transaction", () => {
      const witnessScriptHex = "522102a8513d9931896d5d3afc8063148db75d8851fd1fc41b1098ba2a6a766db563d42103938dd09bf3dd29ddf41f264858accfa40b330c98e0ed27caf77734fac00139ba52ae";
      const multisig = generateMultisigFromHex(TESTNET, P2SH_P2WSH, witnessScriptHex);
      ...
      const transactionSignature1 = ["30450221009c3ffa779e7b9d7e3c16797f6a115a041e1df6026e963b20bb71990d351e5e840220020361210576fba1b77846693ccf4fc81839bbf677cc24f41dc32127bad1a4be01"];
      const transactionSignature2 = ["304402206066043094575afffae92f17cb19503bc2bb9b80cd040462b4237f8fc14b39d1022008a9c89d39032d1732b80320194595c7f0411750b426b7c16e8d99b957c3abde01"];
      const signedTransactionHex = "";
    ...
    it("can construct a valid signed P2WSH transaction", () => {
      const witnessScriptHex = "522102a8513d9931896d5d3afc8063148db75d8851fd1fc41b1098ba2a6a766db563d42103938dd09bf3dd29ddf41f264858accfa40b330c98e0ed27caf77734fac00139ba52ae";
      const multisig = generateMultisigFromHex(TESTNET, P2WSH, witnessScriptHex);
      ...
      const outputs = [
        {
          address: "tb1qreu0lyeqxyj7gumhpgs38l4va89arpt8qnks9fklw0x98qkjdj6sgg3anx",
          amountSats: 99849,
        }
      ];

      const transactionSignature1 = ["3044022055a8e9b906ec3d838d508f654cbcd6619564c36613bdffc73cc35b9254d082ea022026004844cc43ddd24fdbe201a1f0abd6202aac4249ef5965d5dc8cfed39e604301"];
      const transactionSignature2 = ["3045022100f6fed44d15fabe1b90be230489b350043065a665ab51c4fb700e966a7d76c63c02204bc315b359014201e4f5bc285aae000414755bcae48f17d9df490a433575d6e301"];
      const signedTransactionHex = "";
