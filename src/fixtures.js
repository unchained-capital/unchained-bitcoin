...
const NODES = {
  "m/45'/0'/0'": {
    ...
    zpub:
      "zpub6qrp73tcNs5GxSEZPtZgs1a8sTjMxuDBvnatMQJrawC5ucyJtXwNNjYrcAmavk6kkhi99GgribUGcVq4w9CCqowdTX1UfX9NXMZzG2XWQdj",
    ypub:
      "ypub6X2YoPDhEBXo793SZXn4evUdhVav2HDh1g4fa1QyCvpCrXA5dsmokftiaxozvqSqM4bLPo6JFw7ijDDWDSnC3aG2bBK45cKtFdWLsUKgtyo",
    Ypub:
      "Ypub6hvdvcx8o96AXiCpWCF3UzpSRHdBEduHKwiLVGgWahecUhizQHA5qnkePfmUVGfjaXfKGP6R99WDrNqGWfw9C4NhReRTV1nt9MnDTNALmuh",
    Zpub:
      "Zpub72kuEHd3wpdeP1PwLZ2fh5uwbFmdBFtnF4EZGfaPxi2VXoYDewKeTrQnQsj4VBKezAn81rgybormjfSqENM9zJ4JHz7t4vcNR5qrqv8qja7",
    upub:
      "upub5DhVaiY2dTMshxGyE6dZpa6d1d18FoFhMDynSRqRguJge7uAdF7ZGRGAW8yewCq9iW87Pti4RHhXC4mFLf88rdXd7pXMjy3wAjFmK6jyHiX",
    vpub:
      "vpub5YXktPCwn8uMZFU64TRC2fC8Bb9aCRFCGLW1DpjK4ugZhDiPsuH7tUvJXLwEw7V589Ev9NJcsx455MNp4MY9esDDzADnKssRSTKQhgCrtoZ",
    Upub:
      "Upub5QbahxGUCQvF8XSMAm6YeeSRjR3PU9wHfVdTMh6y4g96GJU5PeVqMY86Jqw8Ve43wyC6GUiBJW62KEP1dtH617eHxHdm9NWw4TXdu1aWzdx",
    Jpub:
      "Vpub5jRr1cwPM6TiypdU17tArjXvuPBqQmvnac9g95zrSgWyKQHJeJfPybnEL3tiVYhyMcJu1xJjmASaCWzaMah6oMKtpdLBjHLRLBbHHcy3jDH",
    chaincode:
  ...
  "m/45'/0'/0'/0": {
    ...
    xpub:
      "xpub6EW9kGJQLjEGWpuKjViLuEw3pkNX5k2DzXhM3ctfHawh12aLXnrzYuRcvwTfv2VD2a8uzFCDJfLnrrD9Z46NbLyPHUQbbb4QyxKjf6c1gh4",
    tpub:
      "tpubDEsnGW8641Bind6BBghS7AGR9sUB58XHYAHeQAwodVhakKF3c1i5hM6TAyYTSXSSpUfpbpi5qmAqZ2hkwuwcUnRgM59uH7ieZuv9RAEJ5Rp",
    chaincode:
  ...
  "m/45'/0'/0'/0/0": {
    ...
    tpub:
      "tpubDG75LxhwXiFdQz1Hx8o8rEL59hVuKyqiCqbxQPdQmgZdmqgxHsHU2Qk2aBY8TqzXcX1wMkVKukrYi5y9FsaqXxiooEG6Z7W24MjojRNcVtA",
    chaincode:
      "4522d0dc37c97548c43adc8fbbe285eea27921e8437562574d13c013e85c0fd3",
        ...
        0: [
          {
            ...
            path: "m/45'/1'/100'/0/0",
            pubkey:
              Buffer.from('02a8513d9931896d5d3afc8063148db75d8851fd1fc41b1098ba2a6a766db563d4', 'hex'),
          },
          {
            masterFingerprint: Buffer.from('00000001', 'hex'),
            path: "m/45'/1'/100'/0/0",
            pubkey:
              Buffer.from('03938dd09bf3dd29ddf41f264858accfa40b330c98e0ed27caf77734fac00139ba', 'hex'),
          },
        ],
        1: [
          {
            ...
            path: "m/45'/1'/100'/0/1",
            pubkey:
              Buffer.from('0221ee4400a394e44b78592463eb07c9bae0cc9c2b11081be97df15cd561124e19', 'hex'),
          },
          {
            masterFingerprint: Buffer.from('00000001', 'hex'),
            path: "m/45'/1'/100'/0/1",
            pubkey:
              Buffer.from('03f31364b009d8019be56fa2569f336362e3e2b6a809623d87ffbef634ca6e1f27', 'hex'),
          },
        ],
        48349: [
          {
            ...
            pubkey:
              Buffer.from('0308e27264d2b28b2e56104b36e562f69414027574998a53674b5db28a649f0f38', 'hex'),
          },
          {
            masterFingerprint: Buffer.from('00000001', 'hex'),
            path: "m/45'/1'/100'/0/48349",
            pubkey:
              Buffer.from('037a911b48783ca769ae273ebe71d3a14d7af2301063c25564155e8764fa77c981', 'hex'),
          },
        ],
      },
      'path': {
...
const MULTISIGS_BASE = [
  {
    ...
    utxos: [
      ...
      {
        txid:
          "f243c1fbb85dd49da91477b89c76636202721be9c7df5ee6eee0c6a10861ae44",
        index: 0,
        amountSats: "100000", // 0.001 BTC
        transactionHex:
    ...
    //   ],
    //   hex:
    //     "",
    //   signature: [
    //     "304402205397795a8b6e0b8d1c5a0b2b5b8fb8e49afb6dd150d1a186604fa9e71e23aaa20220514b7b7ed9ec43d983d7be5ea4ece5a55b29efa2193d90bf1fd087356fcbd54b01",
    ...
    transaction: {
          ...
          bip32Derivation: [
            {
              ...
              path: "m/45'/1'/100'/1/0",
              pubkey:
                Buffer.from('03a00095df48367ed21e5c6edd50af4352311bf060eb100425cb7af4331aa1aad0', 'hex'),
            },
            {
              masterFingerprint: Buffer.from('00000001', 'hex'),
              path: "m/45'/1'/100'/1/0",
              pubkey:
                Buffer.from('021a049747120345fa9017fb42d8ff3d4fb1d2ef4c80546872c5da513babd51585', 'hex'),
            },
          ],
      ...
      hex:
        "",
      signature: [
...

  {
    ...
    utxos: [
      {
        txid:
          "429da41d05db69d7c006e91b15031e6d47faab15adba3c97059eeea093c36a23",
        index: 0,
        amountSats: "100000", // 0.001 BTC
        transactionHex:
      ...
      {
        txid:
          "d8edcd3ef4293a2554a147f048442d735fb54b901c1e39ffdb59448c1abae812",
        index: 0,
        amountSats: "100000", // 0.001 BTC
        transactionHex:
      ...
      {
        txid:
          "ff43f4cc8473341ce9effb91d715a4deb4e8a8cb669dd1d119a3a30552a829d1",
        index: 0,
        amountSats: "100000", // 0.001 BTC
        transactionHex:
    ...
    //   ],
    //   hex:
    //     "",
    //   signature: [
    //     "30440220571b44fea349bb6d41698269f47a3b481186b5823457f50e5836f3674d78aee802206730c2d4366c83dc57afa1f2d31a70b6a5ef5345555025fb0245f03393275ae201",
    ...
    transaction: {
          ...
          bip32Derivation: [
            {
              ...
              pubkey:
                Buffer.from('02ade44fc6568a4a334b1797140534707a5dd60c247a59523c577ad9eb59d798ba', 'hex'),
            },
            {
              masterFingerprint: Buffer.from('00000002', 'hex'),
              path: "m/48'/1'/100'/1'/1/0",
              pubkey:
                Buffer.from('02489bfaa3dc33e5d2325295d9d1367f35a45fce09c96db6456fc712938dc2c0c7', 'hex'),
            },
          ],
      ...
      hex:
        "",
      signature: [
...

  {
    ...
    utxos: [
      {
        txid:
          "84df8dcc9b86e8c7bb39ce0ba9f577ec750f0b64df97a5c9559cf39243a1f501",
        index: 0,
        amountSats: "100000", // 0.001 BTC
        transactionHex:
      ...
      {
        txid:
          "f010998e033355636c2ba34af753cd6d5f198889a379bc30625bb38f646f3d72",
        index: 0,
        amountSats: "100000", // 0.001 BTC
        transactionHex:
      ...
      {
        txid:
          "f8b3867a14b39c537e8fbda669c5f956bb31744bf396a7e5b2a68ba43a874283",
        index: 1,
        amountSats: "100000", // 0.001 BTC
        transactionHex:
    ...
    //   ],
    //   hex:
    //     "",
    //   signature: [
    //     "3044022047f573cd0f5b2a24f097d0f794c668b8c7384853fb5373defc6b48f505943654022017fdd51081e1a2f932b843c8046c9821fd863fdb73b6398e2a145c14d9009f8101",
    ...
    transaction: {
          ...
          bip32Derivation: [
            {
              ...
              pubkey:
                Buffer.from('02f45fa86e1ac4e69c0f183c769db9157740586c78b24c495be0404c1e6ae029e5', 'hex'),
            },
            {
              masterFingerprint: Buffer.from('00000003', 'hex'),
              path: "m/48'/1'/100'/2'/1/0",
              pubkey:
                Buffer.from('03610bec03e459c7fa28c9a36c4c9db6e2c4bc2ae4e2764aa3d035599c7052e33f', 'hex'),
            },
          ],
      ...
      hex:
        "",
      signature: [
...

  {
    ...
    utxos: [
      {
        txid:
          "456813be8389d17e945c0b91b5112938a7268bb7c6721147bce6521eeabde7b0",
        index: 0,
      ...
      {
        txid:
          "5bbf64e036e46bf93dadc770f0415f6566453b9ae2d932df00fd5b5e49bdbbd5",
        index: 1,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
      ...
      {
        txid:
          "74c11de1a3f1a5daa06441d78d7fb45609b3415721466c6256bffd881451cda5",
        index: 0,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
    ...
    //   ],
    //   hex:
    //     "",
    //   signature: [
    //     "30440220093e19b884411f941ccebe9a175e3e36a91c60b469ad1b8b9983017943b6e2550220583fde25a48ee2627c1c2496cf46784f2a12803378c443969b3779fea62e23ae01",
    ...
    transaction: {
          ...
          bip32Derivation: [
            {
              ...
              path: "m/45'/0'/100'/1/0",
              pubkey:
                Buffer.from('0360fc2c3410b3700822c31d4901640cf763714f30ff45f887e86bee8733509ebe', 'hex'),
            },
            {
              masterFingerprint: Buffer.from('00000004', 'hex'),
              path: "m/45'/0'/100'/1/0",
              pubkey:
                Buffer.from('039c064999a7c238c31ee018b1b7983fb657edfdf23f4d46bde919817a39cbcbb3', 'hex'),
            },
          ],
      ...
      hex:
        "",
      signature: [
...

  {
    ...
    utxos: [
      {
        txid:
          "2062282a8c6644740d4a5c85a74ad21c6a0fda8d753e8a4bdfba09a26d20eb40",
        index: 1,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
      ...
      {
        txid:
          "4c211951fa39a412d3f5f42013022eefd16954694cc37c57bff769ef909ef9e7",
        index: 0,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
      ...
      {
        txid:
          "c5d0e548e2332450057ce5bd2a6fb720b2c8bd6f595ed11fdba71488b1bf7b31",
        index: 1,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
    ...
    //   ],
    //   hex:
    //     "",
    //   signature: [
    //     "304402207da18a5f73e691fcd2451252919cada67c47f267fbc48cc729d4809c5ec9bcbe0220428d5ead8e9654586946dbd2e10e2a0f3677e405708f82c139be7adcccc36d1c01",
    ...
    transaction: {
          ...
          bip32Derivation: [
            {
              ...
              pubkey:
                Buffer.from('029997f9c7094881d241b13b14d8567cdedcaccd411844c55fe09b0b8ca1b254b1', 'hex'),
            },
            {
              masterFingerprint: Buffer.from('00000005', 'hex'),
              path: "m/48'/0'/100'/1'/1/0",
              pubkey:
                Buffer.from('0272834f652444910e1cc157b99f52fd6052826a11f9099879a55490f6b8190be7', 'hex'),
            },
          ],
      ...
      hex:
        "",
      signature: [
...

  {
    ...
    utxos: [
      {
        txid:
          "4ab356fef8b8205a3b96b4924e8e94f18c4b8ecdefa0bb1ee28ce19f091c3f58",
        index: 0,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
      ...
      {
        txid:
          "a21b384dc72b9ef2559339cecd5ad2652171589b1e479497817b617734859d90",
        index: 1,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
      ...
      {
        txid:
          "af6e299c95d19abe3d99da27198355c4b52b4746ac985ab622284e286957a31a",
        index: 0,
        amountSats: "10000", // 0.0001 BTC
        transactionHex:
    ...
    //   ],
    //   hex:
    //     "",
    //   signature: [
    //     "304402200fe08792d643474fd8ddc240490e5410a349ede40a104ebc58aadf0b6b85674602203fb7d07a39257d8e2d4e6d137d9606539df177e94823b1dff78e2f37e5f28cfc01",
    ...
    transaction: {
          ...
          bip32Derivation: [
            {
              ...
              pubkey:
                Buffer.from('038b5e295f14f6a848f55b7d62efddef4679dc361ecda5f6cd074cc24ae2174510', 'hex'),
            },
            {
              masterFingerprint: Buffer.from('00000006', 'hex'),
              path: "m/48'/0'/100'/2'/1/0",
              pubkey:
                Buffer.from('0318a60afc9aa7e3191f9e49051c70764f7688d9a567b327c095e5a3f75f8847e7', 'hex'),
            },
          ],
      ...
      hex:
        "",
      signature: [
