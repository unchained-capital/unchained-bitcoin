 ...
 * @example
 * const result = generateMultisigFromSpec(NETWORKS.MAINNET, MULTISIG_ADDRESS_TYPES.P2SH, 3, pubkey1, pubkey2, ..., pubkeyn);
 * @returns {Multisig} object for further parsing
 */
export function generateMultisigFromSpec(network, addressType, requiredSigners, ...publicKeys) {
 ...
 * const multi = generateMultisigFromHex(NETWORKS.MAINNET, MULTISIG_ADDRESS_TYPES.P2SH, redeemScript);
 * @returns {Multisig} object for further parsing
 */
 ...
 * @returns {Transaction} an unsigned [Transaction]{@link https://github.com/bitcoinjs/bitcoinjs-lib/blob/master/types/transaction.d.ts} object
 */
